...
public class RepoServer {
    ...
    public static void main(String[] args) {
        ...
        Airlift repository = new Airlift(rmiRegHostName, rmiRegPortNumb);
        RepoInterface repositoryInterface = null;
        
        try {
            repositoryInterface = (RepoInterface) UnicastRemoteObject.exportObject((Remote) repository, RegistryConfiguration.PORT_REPO);
        }
        ...
        try {
            reg.bind(RegistryConfiguration.RMI_REGISTRY_REPO_NAME, repositoryInterface);
        }
        catch(RemoteException e) {
